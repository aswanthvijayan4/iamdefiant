...
import 'package:authentication_with_bloc/Screens/Reports/Inventory/Stock/ClosingStockReport.dart';
...
import 'package:authentication_with_bloc/Widgets/ReportsSampleWidget.dart';
...
class _MyDrawerState extends State<MyDrawer> {
  ...
  @override
  Widget build(BuildContext context) {
    String uid = (BlocProvider.of<AuthenticationBloc>(context).state
                          ...
                          children: [
                            ...
                            ListTile(
                              ...
                              onTap: () {
                                Navigator.push(
                                  context,
                                  RouteTransition(page: branchBloc(uid: uid)),
                                );
                                // Navigator.of(context).push(MaterialPageRoute(
                                //     builder: (_) => InventoryItemsListScreen()));
                              },
