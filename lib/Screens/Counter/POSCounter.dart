import 'package:authentication_with_bloc/Blocs/POS/InvGroups/invgroupspos_cubit.dart';
import 'package:authentication_with_bloc/Blocs/POS/InvItems/invitemspos_cubit.dart';
...
import 'package:authentication_with_bloc/Screens/Counter/CartWidget.dart';
import 'package:authentication_with_bloc/Screens/Counter/POSCartList.dart';
...
class _POSCounterScreenState extends State<POSCounterScreen> {
  ...
  Widget build(BuildContext context) {
    AppBar appBar = AppBar(
      ...
      title: Text('authentication_with_blocTouch'),
      // Shimmer.fromColors(
      //     child: Text('authentication_with_blocTouch'),
      //     baseColor: Colors.green[900],
      //     highlightColor: Colors.grey), //Text('authentication_with_blocTouch'),
    );
