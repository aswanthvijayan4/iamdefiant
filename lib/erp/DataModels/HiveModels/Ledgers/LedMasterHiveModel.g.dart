...
class LedMasterHiveModelAdapter extends TypeAdapter<LedMasterHiveModel> {
  @override
  final int typeId = 21;

  @override
  LedMasterHiveModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return LedMasterHiveModel()
      ..LEDGER_ID = fields[36] as String
      ..Ledger_Name = fields[1] as String
      ..Ledger_Type = fields[2] as String
      ..Group_Id = fields[3] as String
      ..Opening_Balance = fields[4] as String
      ...
      ..Contact_Person = fields[17] as String
      ...
      ..Birth_Date = fields[24] as String
  ...
  @override
  void write(BinaryWriter writer, LedMasterHiveModel obj) {
    writer
      ..writeByte(36)
      ..writeByte(36)
      ..write(obj.LEDGER_ID)
  ...
  bool operator ==(Object other) =>
      ...
      other is LedMasterHiveModelAdapter &&
